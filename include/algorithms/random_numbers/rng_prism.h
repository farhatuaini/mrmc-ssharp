...
*
*	Source description:
*               A C library for generating random numbers. It mostly relies
*		on the common C standard functions rand() and srand().
*		The method used for generating random numbers is a linear
*		congruential one and returns uniformly distributed random
...
*/
extern inline double generateRandUnifPR(void * pRandGenerator);
...
*/
extern inline void generateSeedPR(void * pRandGenerator, unsigned long s);
