...
*
*	Source description:
*		This is an ANSI C library for random number generation.
*		The use of this library is recommended as a replacement
*		for the ANSI C rand() and srand() functions, particularly
*		in simulation applications where the statistical
...
*		pseudo-random number uniformly distributed between 0.0
*		and 1.0.  The period is (m - 1) where m = 2,147,483,647
*		and the smallest and largest possible values are (1 / m)
*		and 1 - (1 / m) respectively.  For more details see:
*
*		"Random Number Generators: Good Ones Are Hard To Find"
*				Steve Park and Keith Miller
*		Communications of the ACM, October 1988
*
*		Note that as of 7-11-90 the multiplier used in this
*		library has changed from the previous "minimal standard"
*		16807 to a new value of 48271.  To use this library in
*		its old (16807) form change the constants MULTIPLIER
*		and CHECK as indicated in the comments.
*
*		Name              : rng_ciardo.c
*				(Random Number Generation - Single Stream)
