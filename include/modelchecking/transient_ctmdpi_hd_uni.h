...
#ifndef TRANSIENT_CTMDPI_H
#define TRANSIENT_CTMDPI_H

#include "bitset.h"

/**
* Compute probability vector from the algorithm of "Efficient
...
*/
extern double *
transient_ctmdpi_hd_uni(const double t, const bitset *B);
